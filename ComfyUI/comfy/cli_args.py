...
parser.add_argument("--diffyui-only", action="store_true", help="DiffyUI mode: remove core image/video generation nodes; keep only load/save/preview and image passthrough for DWI workflows.")
